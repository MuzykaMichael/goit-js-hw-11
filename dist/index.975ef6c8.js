...
(0, _dataJs.refs).formEl.addEventListener("submit", function(event) {
    ...
    if (searchVal.trim() == "") {
        (0, _notiflixDefault.default).Report.failure("Input can't be empty!!!");
        return;
    }
    pageParams = 1;
    (0, _axiosDefault.default)({
        ...
        params: {
            key: (0, _dataJs.refs).pixabayKey,
            q: searchVal,
            image_type: "photo",
            orientation: "horizontal",
            safesearch: true,
            per_page: (0, _dataJs.refs).PER_PAGE,
            page: pageParams
        }
    }).then(function(response) {
        if (response.data.hits.length == 0) {
            (0, _notiflixDefault.default).Report.info("Sorry, there are no images matching your search query. Please try again.");
            return false;
        }
        isCanLoad = response.data.totalHits > (0, _dataJs.refs).PER_PAGE ? true : false;
...
},{"notiflix":"5z0Oc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","axios":"jo6P5","./data.js":"9kapS","./functions.js":"2jd1e"}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
...
const refs = {
    pixabayKey: "36775242-4d09ae0ae77a78f3b8d2db4c6",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2jd1e":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./data.js":"9kapS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequired7c6")
